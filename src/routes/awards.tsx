...
const awards = [
  ...
  { year: "2023", title: "MDRT Qualifier", org: "Million Dollar Round Table", Icon: Award },
...
function AwardsPage() {
  return (
    <>
      <PageHero eyebrow="Awards & Achievements" title="Recognised excellence, earned in trust." sub="A glimpse of milestones, certifications and recognitions from across the industry." />

      <Section>
        <SectionHeader eyebrow="Our Recognition" title="Our Awards & Achievements" sub="Each recognition reflects the trust placed in us by 1000+ families." />
